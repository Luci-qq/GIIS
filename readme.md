...
3. Введите координаты точек в соответствующие поля ввода или нажмите кнопку "Выбрать файл" для загрузки точек из файла.
4. Нажмите кнопку "Нарисовать" для построения выпуклой оболочки на холсте.
5. Если необходимо, включите отладочный режим, установив флажок "Отладочный режим" для вывода точек выпуклой оболочки в текстовую область.
